...
const Election2024 = () => {
  ...
  return (
    <div className='container mx-auto mt-10'>
              <div className='border-b-[1px] border-gray-500 pb-4'>
                <div className='flex justify-between mb-2'>
                    <div className='text-xl md:text-2xl font-semibold pb-2 md:pb-4'>Follow the latest results, coverage and analysis</div>          
